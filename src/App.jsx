...
import { Home, Search, Plus, MessageCircle, User, Image as ImageIcon, Send, Sparkles, MapPin, Smile, X, Music, Volume2, Settings, Check, ArrowLeft, Users, MessageSquare, Calendar, Book, Edit2, Activity } from 'lucide-react';
...
{/* Nieuwe comment sectie (voorkomt 'unused variable' foutmeldingen op Vercel) */}
...
className={`flex-1 p-2.5 text-xs ${shapes.button} ${bgs.input} outline-none border focus:${colors.border}`}
autoFocus
/>
<button
onClick={() => addComment(post.id)}
className={`p-2.5 ${shapes.button} ${colors.mainBg} text-white shadow-md hover:brightness-110 active:scale-95 transition-all`}
>
